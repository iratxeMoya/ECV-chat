    ...
    _createClass(EmojiPicker, [{
      ...
      value: function generateElements(emojiInput) {
        var clickLink = function clickLink(event) {
          ...
          emojiInput.focus();
		  emojiInput.selectionStart = caretPos + 1;
		  emojiInput.selectionEnd = caretPos + 1;
